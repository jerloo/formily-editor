...
const appendXComponent = (schema: ISchema, expression = false) => {
...
export default contex => {
  ...
  currentSchema['x-component-props'] = Object.assign(
    {},
  ...
  const xComponentDataSource = contex['x-components'].filter(
    item => item.type === currentSchema.type
  )
