...
const TreeNode: React.FC<ITreeNodeProps> = props => {
  ...
  const style = {
    ...
    transform: `translate(${scaffoldBlockPxWidth *
      (scaffoldBlockCount - 1)}px)`,
  ...
  return connectDropTarget(
    <div
      ...
      className={cls('rst__node', rowDirectionClass, {
        active:
          nodeRendererActions.getActiveNodePath() === node.data.path.join('.')
      })}
    >
