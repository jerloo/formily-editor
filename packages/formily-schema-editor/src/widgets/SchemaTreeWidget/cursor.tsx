...
const Cursor: React.FC<ICursorProps> = ({
  ...
  useEffect(() => {
    requestAnimationFrame(() => {
      // requestAnimationFrame等到目标dom挂载后，拿到
      ...
      if (dom) {
        ...
        setActivedNode({
          activedNodePath: currentSchema.path,
          nodeType: currentSchema.type
        })
      }
    })
    ...
    <Fragment>
      <div
        ...
        style={{
          ...
          top:
            cursorPosition.top -
            containerDomPostion.current.top +
            ...
            <div className="rst__rowCursor__cnt__iconContaner">
              <div className="zoom-cnt">
                <div className="zoon-cnt__iconContainer">
                  {showLeaf && (
                    <i
                      className="zoom-cnt__iconContainer__icon iconfont icon-zijiedian"
                      onClick={e => insertChildNode(e, 'leaf')}
                    />
                  )}
                  {showSibling && (
                    <i
                      className="zoom-cnt__iconContainer__icon iconfont icon-xiongjiedian"
                      onClick={e => insertChildNode(e, 'sibling')}
                    />
                  )}
                </div>
              </div>
